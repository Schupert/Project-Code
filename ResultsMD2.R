  ...
  for (l in Hetero_New){
    ...
    for (k in Updated_Studies){
      ...
      for(n in 1:Repeats){
        ...
        RE_Results_MD$MLM_Est[counter] <- z$b[[1]]
        RE_Results_MD$MLM_Est_SE[counter] <- z$se[[1]]
        RE_Results_MD$MLM_Est_p[counter] <- z$pval[[1]]
        RE_Results_MD$MLM_CI_lb[counter] <- z$ci.lb[[1]]
        RE_Results_MD$MLM_CI_ub[counter] <- z$ci.ub[[1]]
        RE_Results_MD$MLM_Mod_Est[counter] <- z$b[[2]]
        RE_Results_MD$MLM_Mod_Est_SE[counter] <-z$se[[2]]
        RE_Results_MD$MLM_Mod_p[counter] <- z$pval[[2]]
        RE_Results_MD$MLM_Mod_CI_lb[counter] <- z$ci.lb[[2]]
        RE_Results_MD$MLM_Mod_CI_ub[counter] <- z$ci.ub[[2]]
        RE_Results_MD$MLM_tau2[counter] <- z$tau2
        RE_Results_MD$MLM_tau2_SE[counter] <- z$se.tau2
        RE_Results_MD$MLM_BIC[counter] <- BIC.rma(z)
        RE_Results_MD$MLM_AIC[counter] <- AIC.rma(z)
        RE_Results_MD$MLM_LogLik[counter] <- logLik.rma(z)
