...
for (m in Mean_Difference_Change){
  ...
  for (l in Hetero_New){
    ...
    for (k in Updated_Studies){
      ...
      MD_Results <- data.table(imported_data)
      setkey(MD_Results, "Rep_Number", "I_U")
      ...
      for(n in 1:Repeats){
        ...
        data_temp_init <- MD_Results[J(n, "I")]
        data_temp_all <- MD_Results[J(n)]
        
        ## Initial meta-analysis (random-effects)
        x <- rma(measure="MD", m1i = Group2Mean, sd1i = Group2SD, n1i = Group2Size, 
                 m2i = Group1Mean, sd2i = Group1SD, n2i = Group1Size, 
        ...
        y <- rma(measure="MD", m1i = Group2Mean, sd1i = Group2SD, n1i = Group2Size, 
                 m2i = Group1Mean, sd2i = Group1SD, n2i = Group1Size, 
        ...
        z <- rma(measure="MD", m1i = Group2Mean, sd1i = Group2SD, n1i = Group2Size, 
                 m2i = Group1Mean, sd2i = Group1SD, n2i = Group1Size, 
      ...
      #nam <- paste("RE_Results_MD", as.integer(m*10), as.integer(l*10), k, sep = "_")
      #assign(nam, RE_Results_MD)
      write.csv(RE_Results_MD, file = "RE_Results_MD_incomplete.csv")
